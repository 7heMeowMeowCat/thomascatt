...
try {
  var CreatePostSection = function CreatePostSection() {
    ...
    }, "Logged in as ", /*#__PURE__*/React.createElement("b", null, window.data.name), /*#__PURE__*/React.createElement("a", {
      href: "logout",
      style: {
        "float": "right"
      }
  ...
  var Post = /*#__PURE__*/function (_React$Component) {
    ...
    function Post(props) {
      ...
      _this.state = {
        liked: _this.props.likes.includes(window.data.name),
        likes: _this.props.likes
      };
      _this.togglePostLike = _this.togglePostLike.bind(_assertThisInitialized(_this));
      return _this;
    }
    ...
    _createClass(Post, [{
      ...
      value: function togglePostLike() {
        ...
        if (!this.state.liked == true) likesToSet.push(window.data.name);else likesToSet = likesToSet.filter(function (a) {
          return a != window.data.name;
        });
        this.setState({
      ...
      value: function render() {
        return /*#__PURE__*/React.createElement("div", {
          className: "card post " + (this.props.author == window.data.name ? "ownpost" : "")
        }, /*#__PURE__*/React.createElement("div", {
          className: "card-header"
        }, this.props.author == window.data.name ? /*#__PURE__*/React.createElement("b", null, "Your Post") : /*#__PURE__*/React.createElement("span", null, "Posted by ", /*#__PURE__*/React.createElement("b", null, this.props.author))), /*#__PURE__*/React.createElement("div", {
          className: "card-body"
        }, /*#__PURE__*/React.createElement("p", {
          style: {
            fontSize: "24px"
          }
        }, this.props.content), /*#__PURE__*/React.createElement("hr", null), /*#__PURE__*/React.createElement("button", {
          className: "btn btn-sm " + (this.state.liked ? "btn-primary" : "btn-outline-primary"),
          onClick: this.togglePostLike
        }, /*#__PURE__*/React.createElement("i", {
          className: "fa fa-thumbs-up"
        }), "\xA0", this.state.likes !== undefined ? this.state.likes.length : 0), /*#__PURE__*/React.createElement("a", {
          href: "posts/" + this.props.id,
          style: {
            "float": "right"
          },
  ...
  var Posts = /*#__PURE__*/function (_React$Component2) {
    ...
    function Posts(props) {
      ...
      _this2.state = {
        content: /*#__PURE__*/React.createElement("center", null, /*#__PURE__*/React.createElement("img", {
          src: imgbase64,
          className: "loader"
    ...
    _createClass(Posts, [{
      ...
      value: function setPosts(posts) {
        ...
        var content = /*#__PURE__*/React.createElement("span", null);
        this.setState({
